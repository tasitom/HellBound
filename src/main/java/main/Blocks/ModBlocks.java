...
public class ModBlocks {
    ...
    public static final DeferredBlock<CorruptedCandle> CANDLE_PRIDE = BLOCKS.registerBlock("pride_candle",properties -> new CorruptedCandle(BlockBehaviour.Properties.of().destroyTime(1).lightLevel(state -> state.getValue(CorruptedCandle.LIT) ? 8 :0),ParticleTypes.SOUL_FIRE_FLAME,"Pride", ChatFormatting.WHITE));
    ...
    public static final DeferredBlock<CorruptedCandle> CANDLE_WRATH = BLOCKS.registerBlock("wrath_candle",properties -> new CorruptedCandle(BlockBehaviour.Properties.of().destroyTime(1).lightLevel(state -> state.getValue(CorruptedCandle.LIT) ? 8 :0),ParticleTypes.SOUL_FIRE_FLAME,"Wrath",ChatFormatting.DARK_BLUE));
