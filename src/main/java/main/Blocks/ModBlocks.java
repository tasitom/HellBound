...
public class ModBlocks {
    ...
    public static final DeferredBlock<CorruptedCandle> CANDLE_LUST = BLOCKS.registerBlock("lust_candle",properties -> new CorruptedCandle(BlockBehaviour.Properties.of().destroyTime(1).lightLevel(state -> state.getValue(CorruptedCandle.LIT) ? 8 :0),ParticleTypes.SOUL_FIRE_FLAME,"Lust",ChatFormatting.LIGHT_PURPLE));
    ...
    public static final DeferredBlock<PedestalBlock> PEDESTAL_BLOCK = BLOCKS.registerBlock("pedestal_block",properties -> new PedestalBlock(BlockBehaviour.Properties.of()));
